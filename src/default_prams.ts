...
function printSalWithBonus(value=2000, bonus=0.1){
 ...
 * @param bonus 
 */
function printSalWithBonus_1(value=2000, bonus=value*0.1){
...
function printSalWithBonus_v1(value=2000, bonus=value*percentBonus){
...
let percentBonusFunc = () => 0.1
//We can assign a function for default value
function printSalWithBonus_v2(value=2000, bonus=value*percentBonusFunc()){
